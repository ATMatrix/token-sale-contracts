...
/// @title ATTPlaceholder Contract
/// @author hackfisher
/// @dev The ATTPlaceholder contract will take control over the ATT after the contribution
///  is finalized and before the ATMatrix Network is deployed.
///  The contract allows for ATT transfers and transferFrom and implements the
